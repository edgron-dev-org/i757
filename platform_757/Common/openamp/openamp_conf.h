...
extern int __OPENAMP_region_start__[];
extern int __OPENAMP_region_end__[];
...
#define VRING_NUM_BUFFS         16  /* number of rpmsg buffers per direction (2026-09-03: 4 -> 16;
                                     * a 4-deep TX ring filled up whenever the CM4 lagged a beat
                                     * and, with the OpenAMP full-ring check compiled out, the
                                     * next send faulted the CM7. 16 x 512 B x 2 = 16 KB of the
                                     * 31 KB shared region; vrings still fit their 0x400 slots) */
