...
__weak uint8_t BSP_SD_Init(void)
{
  ...
  if (hsd1.State == HAL_SD_STATE_READY)   /* direct edit (registered): card already initialized by app_p5_test (self-chosen div2 params), a second HAL_SD_Init errors -> FR_NOT_READY; let it pass idempotently */
  {
    return MSD_OK;
  }
