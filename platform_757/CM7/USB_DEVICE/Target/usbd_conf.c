...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  */
    ...
    PeriphClkInitStruct.UsbClockSelection = RCC_USBCLKSOURCE_HSI48;  /* direct edit (registered): generated placeholder = PLL1Q = 61.5MHz not 48; HSI48 already enabled by app_init (RNG), CRS auto-trim in app_periph_init */
