...
void MX_USART2_UART_Init(void)
{
  ...
  huart2.Init.BaudRate = USART2_BPS;
...
void MX_USART3_UART_Init(void)
{
  ...
  if (HAL_UART_Init(&huart3) != HAL_OK)   /* direct edit (registered): the original HAL_RS485Ex_Init used PD12 hardware DE — PD12 = subcard I2C4_SCL, a pin-collision legacy issue; the real 485_3 DE = PI1 GPIO (belongs to App/uart_drv) */
  {
    Error_Handler();
  }
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  return;  /* neutered: port owned by app_mbfront_cm4/uart_drv (self clk/DMA/NVIC/pins); generated LINKDMA would hijack handles. */
  ...
  */
    ...
    PB10     ------> USART3_TX
    PB11     ------> USART3_RX
    (direct edit (registered): the fake PD12 DE was removed — PD12 = subcard I2C4_SCL)
    */
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA0     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_15|GPIO_PIN_0);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB10     ------> USART3_TX
    PB11     ------> USART3_RX
    (direct edit (registered): the fake PD12 DE was removed)
    */
